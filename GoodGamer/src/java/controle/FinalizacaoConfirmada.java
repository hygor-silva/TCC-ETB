...
public class FinalizacaoConfirmada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Finalização Confirmada</title>");
            out.println("</head>");
            out.println("<body>");

            try {
                Venda v = new Venda();
                v.setId_venda(id_venda);
                v.setValor(valor_total);
                VendaDAO vDB = new VendaDAO();
                vDB.conectar();
                vDB.finalizarVenda(v);
                vDB.desconectar();

                out.print("<script language='javascript'>");
                out.print("alert ('Venda finalizada!');");
