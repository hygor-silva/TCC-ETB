...
public class CancelarVenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print("decisao = confirm('Tem certeza de que deseja cancelar esta venda?\\n- OK para CANCELAR a venda.\\n- Cancelar para CONTINUAR a venda.');");
        out.print("if (decisao){location.href='cancelamento_confirmado.do?id_venda=" + id_venda + "';}");
